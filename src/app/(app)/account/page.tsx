...
export default async function AccountPage() {
  ...
  return (
    <section className='rounded-lg bg-neutral-50 px-4 py-16'>
      <h1 className='mb-8 text-center text-neutral-900'>Account</h1>
...
function Card({
  ...
  return (
    <div className='m-auto w-full max-w-3xl rounded-md bg-zinc-50'>
      <div className='p-4'>
